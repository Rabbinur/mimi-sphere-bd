...
export function ItemCard({ product }: ItemCardProps) {
    ...
    return (
        <>
            <div className="group relative flex flex-col bg-white rounded-2xl border border-slate-100 p-2.5 sm:p-3 transition-all duration-300 hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] hover:border-slate-200 h-full">
