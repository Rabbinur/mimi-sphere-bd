...
export function ItemCard({ product }: ItemCardProps) {
    ...
    return (
        <>
            <div className="group relative flex flex-col bg-white rounded-2xl border border-slate-100 p-2.5 sm:p-3 transition-all duration-300 hover:shadow-md hover:border-slate-200/80 h-full">
                ...
                >
                    ...
                    {/* Subtle Brand Watermark on Corner */}
                    <div className="absolute bottom-1.5 left-1.5 z-10 pointer-events-none opacity-60 group-hover:opacity-100 transition-opacity">
                        <Image
                            src="/logo.png"
                            alt="Mimi Sphere"
                            width={80}
                            height={24}
                            className="object-contain h-4 w-auto drop-shadow-2xs"
                        />
                    </div>
                </Link>
                ...
                <div className="flex flex-col flex-grow justify-between">
                    <div>
                        ...
                        {/* Subtitle / Vendor (e.g. 50 gm in reference) */}
                    ...
                    <div className="flex items-center justify-between mt-2.5 pt-1">
                        ...
                        {/* Circular Action Button (Shopping Bag icon for intuitive Add to Cart) */}
                        <button
                            onClick={() =>
